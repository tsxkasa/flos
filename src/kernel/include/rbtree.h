...
static __always_inline void __rb_add(
...
#define __node_2_linked_node(_n) rb_entry((_n), struct rb_node_linked, node)
...
static __always_inline void rb_link_noop(struct rb_node *n, struct rb_node *p,
                                         struct rb_node **l) {}
